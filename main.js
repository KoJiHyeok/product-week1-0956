...
const defaultGalleryImages = [
...

  {
    ...
    title: "새로 추가한 제목 연습 이미지 1",
    description: "새로 추가한 이미지입니다. 화면에서 가장 먼저 보이는 대상, 배경의 분위기, 시선이 머무는 지점을 중심으로 제목을 만들어보세요.",
    alt: "새로 추가한 제목 연습 이미지 1",
    prompt: "사진 속 중심 대상과 주변 분위기를 짧은 제목으로 연결해보세요.",
    observationPoints: ["가장 먼저 눈에 들어오는 중심 대상", "배경이 만드는 분위기", "제목으로 살릴 수 있는 작은 단서"],
    exampleTitles: ["첫눈에 걸린 장면", "오늘의 단서", "이 사진의 한 문장"],
    ...photoSourcePresets.curated,
  },
  {
    id: "imm-002",
    src: "assets/gallery/webp/다운로드.jpg",
    title: "새로 추가한 제목 연습 이미지 2",
    description: "새로 추가한 이미지입니다. 사진의 상황을 단정하기보다 장면에서 느껴지는 감정과 인상을 짧게 붙잡는 연습에 어울립니다.",
    alt: "새로 추가한 제목 연습 이미지 2",
    prompt: "사진이 주는 첫인상을 한 문장보다 짧은 제목으로 줄여보세요.",
    observationPoints: ["사진의 전체적인 색감", "중심 대상의 위치", "장면에서 느껴지는 감정"],
    exampleTitles: ["분위기가 먼저 말한 날", "짧게 남은 장면", "사진 속 첫인상"],
    ...photoSourcePresets.curated,
  },
  {
    id: "imm-003",
    src: "assets/gallery/webp/다운로드 (1).jpg",
    title: "새로 추가한 제목 연습 이미지 3",
    description: "새로 추가한 이미지입니다. 사진 안의 표정, 자세, 거리감처럼 눈에 보이는 단서를 골라 자연스러운 제목으로 바꿔보세요.",
    alt: "새로 추가한 제목 연습 이미지 3",
    prompt: "사진 속 보이는 단서 하나를 골라 제목의 핵심 단어로 삼아보세요.",
    observationPoints: ["표정이나 자세에서 보이는 변화", "앞쪽과 뒤쪽의 거리감", "눈길을 끄는 소품이나 배경"],
    exampleTitles: ["단서 하나면 충분해", "잠깐 멈춘 순간", "장면의 중심"],
    ...photoSourcePresets.curated,
  },
  {
    id: "imm-004",
    src: "assets/gallery/webp/다운로드 (2).jpg",
    title: "새로 추가한 제목 연습 이미지 4",
    description: "새로 추가한 이미지입니다. 평범한 장면이라도 화면 안의 대비, 반복, 비어 있는 공간을 보면 제목의 방향을 잡기 쉽습니다.",
    alt: "새로 추가한 제목 연습 이미지 4",
    prompt: "사진 속 대비되는 요소를 찾아 짧은 반전형 제목으로 만들어보세요.",
    observationPoints: ["밝고 어두운 부분의 대비", "반복되는 형태나 색", "비어 있는 공간이 주는 느낌"],
    exampleTitles: ["비어 있어서 더 보이는 것", "조용한 대비", "작은 반전의 자리"],
    ...photoSourcePresets.curated,
  },
  {
    id: "imm-005",
    src: "assets/gallery/webp/다운로드 (3).jpg",
    title: "새로 추가한 제목 연습 이미지 5",
    description: "새로 추가한 이미지입니다. 사진이 보여주는 순간을 사건처럼 과장하거나, 반대로 차분하게 낮춰 표현하면서 제목의 톤을 비교해보세요.",
    alt: "새로 추가한 제목 연습 이미지 5",
    prompt: "같은 장면을 재미있는 제목과 차분한 제목 두 방향으로 떠올려보세요.",
    observationPoints: ["순간적으로 포착된 동작", "장면의 속도감", "제목의 톤을 바꿀 수 있는 요소"],
    exampleTitles: ["작은 사건 발생", "지나가기 전의 표정", "오늘의 결정적 장면"],
    ...photoSourcePresets.curated,
  },
  {
    id: "imm-006",
    src: "assets/gallery/webp/다운로드 (4).jpg",
    title: "새로 추가한 제목 연습 이미지 6",
    description: "새로 추가한 이미지입니다. 사진 속 대상이 무엇을 보고 있는지, 무엇을 기다리는지 상상하면 제목에 이야기를 담기 쉽습니다.",
    alt: "새로 추가한 제목 연습 이미지 6",
    prompt: "사진 속 대상의 다음 행동을 상상하되, 너무 길지 않은 제목으로 정리해보세요.",
    observationPoints: ["시선이 향하는 방향", "다음 장면을 예상하게 하는 자세", "배경과 중심 대상의 관계"],
    exampleTitles: ["다음 장면 직전", "기다림의 방향", "곧 시작될 이야기"],
    ...photoSourcePresets.curated,
  },
  {
    id: "imm-007",
    src: "assets/gallery/webp/다운로드 (5).jpg",
    title: "새로 추가한 제목 연습 이미지 7",
    description: "새로 추가한 이미지입니다. 장면에서 가장 강한 감정을 하나 고르고, 설명을 덜어낸 짧은 제목으로 표현해보세요.",
    alt: "새로 추가한 제목 연습 이미지 7",
    prompt: "사진의 감정을 한 단어로 고른 뒤, 그 단어를 중심으로 제목을 만들어보세요.",
    observationPoints: ["장면에서 느껴지는 가장 강한 감정", "감정을 만드는 표정이나 색", "설명을 줄였을 때 남는 핵심 단어"],
    exampleTitles: ["한 단어로 남은 오후", "감정의 중심", "설명보다 먼저 온 느낌"],
    ...photoSourcePresets.curated,
  },
  {
    id: "imm-008",
    src: "assets/gallery/webp/다운로드 (6).jpg",
    title: "새로 추가한 제목 연습 이미지 8",
    description: "새로 추가한 이미지입니다. 사진의 구도와 중심선을 살펴보며, 시선이 움직이는 순서를 제목에 반영해보세요.",
    alt: "새로 추가한 제목 연습 이미지 8",
    prompt: "눈이 처음 닿는 곳과 마지막에 머무는 곳을 연결해 제목을 붙여보세요.",
    observationPoints: ["시선이 처음 닿는 위치", "사진 안에서 이어지는 방향", "마지막에 남는 대상이나 분위기"],
    exampleTitles: ["시선이 도착한 곳", "처음과 마지막 사이", "사진이 이끄는 방향"],
    ...photoSourcePresets.curated,
  },
  {
    id: "imm-009",
    src: "assets/gallery/webp/다운로드 (7).jpg",
    title: "새로 추가한 제목 연습 이미지 9",
    description: "새로 추가한 이미지입니다. 사진의 작은 소품이나 배경 요소를 주인공처럼 바라보면 의외의 제목을 만들 수 있습니다.",
    alt: "새로 추가한 제목 연습 이미지 9",
    prompt: "중심 대상이 아닌 작은 요소 하나를 주인공으로 삼아 제목을 만들어보세요.",
    observationPoints: ["작지만 눈에 띄는 배경 요소", "중심 대상과 주변 소품의 관계", "의외성을 만들 수 있는 포인트"],
    exampleTitles: ["주인공은 뒤에 있었다", "작은 단서의 등장", "배경의 반격"],
    ...photoSourcePresets.curated,
  },
  {
    id: "imm-010",
    src: "assets/gallery/webp/다운로드 (8).jpg",
    title: "새로 추가한 제목 연습 이미지 10",
    description: "새로 추가한 이미지입니다. 사진 속 움직임, 정지된 자세, 주변의 흐름을 비교하면서 장면의 리듬을 제목으로 옮겨보세요.",
    alt: "새로 추가한 제목 연습 이미지 10",
    prompt: "사진 안에서 멈춘 것과 움직이는 것을 나눠 보고 제목으로 묶어보세요.",
    observationPoints: ["움직임이 느껴지는 부분", "정지된 듯한 중심 대상", "주변 흐름과 중심 장면의 차이"],
    exampleTitles: ["멈춘 순간의 리듬", "움직임 사이의 한 컷", "조용히 지나가는 장면"],
    ...photoSourcePresets.curated,
  },
  {
    id: "imm-011",
    src: "assets/gallery/webp/다운로드 (9).jpg",
    title: "새로 추가한 제목 연습 이미지 11",
    description: "새로 추가한 이미지입니다. 사진 전체를 설명하려 하기보다, 기억에 남는 한 장면만 골라 짧고 선명한 제목을 만들어보세요.",
    alt: "새로 추가한 제목 연습 이미지 11",
    prompt: "사진에서 가장 오래 기억날 장면 하나를 골라 제목으로 남겨보세요.",
    observationPoints: ["가장 기억에 남는 한 부분", "제목으로 줄일 수 있는 핵심 이미지", "사진 전체의 분위기를 대표하는 단어"],
    exampleTitles: ["기억에 남은 한 컷", "오늘의 마지막 장면", "한 장면으로 충분한 말"],
    ...photoSourcePresets.curated,
  },
];
...
function getAdminContentStatusLabel(item) {
  const statuses = [];
